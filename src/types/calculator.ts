...
export interface AdmissionOutcomeYearData {
  p50: number | null;
  p70: number | null;
  minimumRequirement: string | null;
}

export interface AdmissionOutcomeEntry {
...
export interface AdmissionOutcomeDataset {
  workbookPath: string;
  sourceSheetName: string;
  exportedAt: string;
  count: number;
  entries: AdmissionOutcomeEntry[];
}

export interface AdmissionOutcomeMatch {
  entry: AdmissionOutcomeEntry;
  score: number;
  matchedBy: string;
}

export interface CalculatedAdmissionRowWithOutcome extends CalculatedAdmissionRow {
  admissionOutcomeMatch: AdmissionOutcomeMatch | null;
}
