...
const baseColumns = [
  ...
  { key: "admissionName", label: "전형명", width: "120px" },
  { key: "recruitmentUnit", label: "모집단위명", width: "154px" },
  ...
  { key: "detailTrack", label: "상세계열", width: "122px" },
] as const;
...
export function ResultsTableV2({ rows, showRegion }: ResultsTableProps) {
